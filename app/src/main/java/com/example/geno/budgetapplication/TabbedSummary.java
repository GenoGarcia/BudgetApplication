...
public class TabbedSummary extends ActionBarActivity {
   ...
   /* ViewPager mViewPager;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_tabbed_summary, menu);
        return true;
    }
  ...
  /*  public static class PlaceholderFragment extends Fragment {
       ...
       /* public static PlaceholderFragment newInstance(int sectionNumber) {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_list_summary, container, false);
            Bundle args = getArguments();
            ((TextView) rootView.findViewById(android.R.id.text1)).setText(Float.toString(args.getInt(ARG_OBJECT)));
            return rootView;
        }
    }
}*/